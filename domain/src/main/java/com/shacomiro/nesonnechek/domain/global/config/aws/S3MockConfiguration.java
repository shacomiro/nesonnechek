package com.shacomiro.nesonnechek.domain.global.config.aws;
...
public class S3MockConfiguration {
	...
	public S3MockConfiguration(@Value("${aws.s3.port}") int s3MockPort, @Value("${aws.s3.bucket}") String localBucketName,
