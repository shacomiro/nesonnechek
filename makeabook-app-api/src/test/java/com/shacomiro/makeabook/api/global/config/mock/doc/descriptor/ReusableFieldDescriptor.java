...
public class ReusableFieldDescriptor {
	...
	public static class EbookModelFieldDescriptor {
		public static final List<FieldDescriptor> EBOOK_MODEL_RES_FIELD_DESCR_LIST = List.of(
				...
				subsectionWithPath("_links").description("HATEOAS link of Ebook").type(JsonFieldType.OBJECT)
		);
		...
		public static final List<FieldDescriptor> EBOOK_COL_MODEL_RES_FIELD_DESCR_LIST = List.of(
				...
				fieldWithPath("_embedded.ebooks.[].type").description("Ebook file type")
						.type(JsonFieldType.STRING),
				fieldWithPath("_embedded.ebooks.[].extension").description("Ebook file extension")
						.type(JsonFieldType.STRING),
				fieldWithPath("_embedded.ebooks.[].downloadCount").description("Ebook download count")
						.type(JsonFieldType.NUMBER),
				fieldWithPath("_embedded.ebooks.[].createdAt").description("Created date of Ebook file")
						.type(JsonFieldType.STRING),
				fieldWithPath("_embedded.ebooks.[].expiredAt").description("Expire date of Ebook file")
						.type(JsonFieldType.STRING),
				fieldWithPath("_embedded.ebooks.[].owner").description("Ebook owner").type(JsonFieldType.STRING),
				subsectionWithPath("_embedded.ebooks.[]._links").description("HATEOAS link of Ebook")
