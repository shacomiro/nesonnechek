...
import com.shacomiro.aws.s3.bucket.AwsS3BucketHandler;
...
public class AwsS3ClientManager {
	...
	private final AwsS3BucketHandler awsS3BucketHandler;
	...
	public AwsS3BucketHandler getAwsS3BucketHandler() {
